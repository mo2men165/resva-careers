...
import { TrendingUp, Globe, DollarSign, Users, Zap, Heart, Shield, Clock, Award, Star, ArrowRight } from 'lucide-react';
...
export const Benefits = () => {
  ...
  return (
    <div id="benefits" className="py-24 px-6 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="inline-block px-4 py-2 bg-[#31a9df]/10 text-[#31a9df] font-semibold text-sm mb-4">
            Why Choose Us
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, i) => (
            <div 
              ...
              className="group bg-white p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden"
            >
              ...
              <div className={`w-16 h-16 bg-gradient-to-br ${benefit.color} flex items-center justify-center text-white mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg`}>
                {benefit.icon}
              </div>
        ...
        <div className="mt-20 bg-gradient-to-br from-[#31a9df] to-[#29aae0] p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-3 bg-white/10 backdrop-blur-sm p-4 hover:bg-white/20 transition-all">
